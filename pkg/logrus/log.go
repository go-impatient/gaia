...
func (l *Logger) WithError(err error) Log {
	wl := WithLogger{
		logger: l,
		err:    err,
	}
...
func (l *Logger) WithField(k string, v interface{}) Log {
	wl := WithLogger{
		logger: l,
		fields: map[string]interface{}{
			k: v,
...
func (l *Logger) WithFields(kv map[string]interface{}) Log {
	wl := WithLogger{
		logger: l,
		fields: kv,
	}
...
// Log the given error as a seperate field.
func (wl *WithLogger) WithError(err error) Log {
	wl.err = err
	return wl
}

// Add given key, value as custom field and value in log.
func (wl *WithLogger) WithField(k string, v interface{}) Log {
...
// Add given key, value pairs as custom fields and values in log.
func (wl *WithLogger) WithFields(kv map[string]interface{}) Log {
	wl.fields = kv
	return wl
}
